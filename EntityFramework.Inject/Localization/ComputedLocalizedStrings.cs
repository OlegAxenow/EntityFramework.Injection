...
namespace EntityFramework.Inject.Localization
{
	...
	public class ComputedLocalizedStrings
	{
		...
		/// <summary>
		/// Property for column with index 3 (if <see cref="DataLocalizationInjection.LocaleIndex"/> equals to zero). 
		/// If <see cref="DataLocalizationInjection.LocaleIndex"/> more than zero -
		/// column with appropriate index will be used for <see cref="Value"/> and this property will be ignored.</summary>
		[DatabaseGenerated(DatabaseGeneratedOption.Computed)]
		...
		/// <summary>
		/// Property for column with index 4 (if <see cref="DataLocalizationInjection.LocaleIndex"/> equals to zero). 
		/// If <see cref="DataLocalizationInjection.LocaleIndex"/> more than zero -
		/// column with appropriate index will be used for <see cref="Value"/> and this property will be ignored.</summary>
		[DatabaseGenerated(DatabaseGeneratedOption.Computed)]
		...
		/// <summary>
		/// Property for column with index 5 (if <see cref="DataLocalizationInjection.LocaleIndex"/> equals to zero). 
		/// If <see cref="DataLocalizationInjection.LocaleIndex"/> more than zero -
		/// column with appropriate index will be used for <see cref="Value"/> and this property will be ignored.</summary>
		[DatabaseGenerated(DatabaseGeneratedOption.Computed)]
